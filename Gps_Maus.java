...
public class Gps_Maus {
    ...
    static Class_GpsKoordinate koordinateAuslesen() throws InterruptedException {
        ...
        */
        ...
        Class_GpsKoordinate koordinate = new Class_GpsKoordinate(laengenGrad, breitenGrad);
        return koordinate;
